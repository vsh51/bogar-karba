    ...
    ILogger<CachedChecklistReadOnlyRepository> logger) : IChecklistReadOnlyRepository
{
    ...
    public Task<List<Application.DTOs.Checklist.ChecklistAccessDto>> GetCollaboratorsAsync(Guid checklistId, CancellationToken cancellationToken = default) =>
        inner.GetCollaboratorsAsync(checklistId, cancellationToken);
}
